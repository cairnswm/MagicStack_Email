...
function getPaymentsApiBaseUrl(): string {
  return process.env.PAYMENTS_API || process.env.PAYMENT_API || process.env.PAYMENT_API_URL || '';
}

function getPaymentsApiKey(): string {
  return process.env.PAYMENTS_API_KEY || process.env.PAYMENT_API_KEY || process.env.API_KEY || '';
}
