...
import emailDocsRouter from './docsEmail';
...
router.get('/', (_req: Request, res: Response) => {
  const page = renderPage('MagicStack API Help', `
    ...
    <nav class="site-nav">
      ...
      <a href="${docsPath}/email">Email docs</a>
    </nav>
          ...
          <div class="cols">
            ...
            <section class="surface">
              ...
              <ul>
                ...
                <li><code>POST /send/:templateCode</code></li>
                <li><code>GET /logs/:tenantId/email</code></li>
                <li><code>GET /template</code></li>
                <li><code>GET ${docsPath}/email</code></li>
              </ul>
            </section>
          </div>
